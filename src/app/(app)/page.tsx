    ...
    <>
        ...
        <main className="flex-grow flex flex-col items-center justify-center px-4 md:px-24 py-12
         bg-gray-800 text-white">
            ...
            <Carousel className="w-full max-w-lg md:max-w-xl" plugins={[Autoplay({delay: 2000})]}>
                <CarouselContent>
                        ...
                        <CarouselItem key={index} className="p-4">
                            <Card>
                                ...
                                space-y-2 md:space-y-0 md:space-x-4">
                                    ...
                                    <div>
                                        <p>{msg.content}</p>
                                        <p className="text-xs text-muted-foreground">{msg.received}</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </CarouselItem>
        ...
        {/* Footer */}
        <footer className="text-center p-2 md:p-2 bg-gray-900 text-white">
